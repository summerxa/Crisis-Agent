This is a nested directory inside of a larger React Native app project. This directory contains backend logic.
In this file, "this project" refers to the current backend directory, NOT the entire overarching project.
